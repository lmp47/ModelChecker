...
\centering
\begin{verbatim}
"Safety property: Var 454"
Number of frames: 3
Average number of literals/clause (not counting transition relation): 1.1185701830863122
Number of ctis: 9
Number of ctgs: 2
Number of queries: 1711
"False"
\end{verbatim}
\caption{Sample output for running the {\it CTG} implementation on example {\tt eijks713.aig}.
\label{sampleoutput}
\end{figure}

\section{Solving}

For all examples that the model checker implementations solved without timing out, the
...
to without timing out was \verb,,. Note that the number of variables in an example is only weakly
