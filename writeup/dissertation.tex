...
that would help reduce the number of residual bugs.
...
checking has been used to verify that circuits correctly implement the algorithm that
the Pentium processors with the FDIV bug did not \cite{clarke96}.
