...
In addition to representing variables with a \verb,Var, type, MiniSat represents
...
\caption{The algorithm for finding the minimal inductive subclause. Clauses are
passed by reference.}
\label{mic}
\end{algorithm}
...
$F_k$ is too loose an approximation, similarly to the reason a consecution
