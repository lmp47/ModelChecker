...
was not only able to solve all the handwritten examples correctly, but to solve
several examples taken from the Hardware Model Checking Competition as well.
