...
\verb,Model, and a \verb,Lit, and returns a \verb,Bool,.}
...
with Aaron Bradley's reference implementation of IC3.
Because MiniSat is the solver used by Aaron Bradley's reference implementation
of IC3, using it as the solver for this project's model checker removes the
