...
where a package may be a library or a complete piece of software.
...
\paragraph{HLint}{
The HLint tool \cite{hlint} suggests improvements for Haskell source code to improve
...
For example, the circuit in figure \ref{aagCircuit} represented is represented
as follows:
\begin{verbatim}
aag 3 0 2 1 1
2 3
