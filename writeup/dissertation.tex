...
For example, the AIGER representation for the circuit in Figure \ref{circuit} is
as follows:
.
...
{\it proveNegCTI} on line \ref{proveNegCTItuple} in Figure \ref{recstr} returns not only
the result
...
For the fourteen handwritten examples and fifty HWMCC examples that all variants solved
