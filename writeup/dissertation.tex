...
The preparation for the project involved distinguishing the main components
of the project, choosing the necessary tools for implementing the components
and developing the code for the project, and gaining the necessary knowledge
about Haskell and the IC3 algorithm.

\section{Haskell}

I provide a brief introduction to Haskell, the language used to implement the
majority of the code for the project.
...
two (ten) examples from HWMCC'13. The solutions given by the model checker implementations
were compared against the solutions given by Aaron Bradley's reference implementation,
and the performance of the model checker implementations were compared with each other
...
agreed with the solutions given by Aaron Bradley's reference implementation.
...
implementation. For each example, forty benchmarking samples were taken, and if the elapsed time for
attempting to solve an example took longer than ten minutes, the attempt was considered to have timed out.
