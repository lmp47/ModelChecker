...
was meant to correctly solve as part of the aims of the project. The model checker
...
my small handwritten examples but also models from the Hardware Model Checking Competitions with hundreds
