...
\subsection{Frames}
The data structure \verb,Frame, represents frames in the IC3 algorithm.
...
$F_k$. After updating frames $F_0, \dlots F_{k - 1}$ to prove that $\neg z$ holds at $F_{k - 1}$,
...
The simplest approximation for MIC involves attempting to drop each literal in turn and checking
