...
expression in figure \ref{hunitex} gives a \verb,TestCase, that tests that function
...
\end{lstlisting}
\caption{An example use of HUnit's {\tt TestCase} and {\tt assertBool}}
\label{hunitex}
\end{figure}
...
posed in conjunctive normal form \cite{minisat,een05}. Further details are given in section \ref{MiniSat}.
}
...
\verb,simple_counters.aig,, having 82 variables. The 
variants could not only solve all the handwritten examples correctly
