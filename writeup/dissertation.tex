...
I now briefly explain the motivations for the deviations from the \emph{Basic} implementation in
Figure \ref{implementationSummary}. The details of these deviations are given in
Section \ref{impl:modelchecker}.
