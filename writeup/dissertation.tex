...
in which case the lathc is considered to be uninitialized.
...
also taken from the set of booleans and literals. The values of $l$, $n$, and $i$ can be used to generate
clauses that describe the latches' initial values and next-state values.
...
$\{l'\}$ is generated because the next-state value for the variable is a constaint-{\it True} value,
