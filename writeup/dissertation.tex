...
The main components of the algorithm here are as follows:
\begin{itemize}
...
gives the same Boolean result as {\it proveNegCTI} in Figure \ref{overview}.
Each $G_i$ gives the value that frame $F_i$ would have after a call to {\it proveNegCTI}
...
phase updated it in Figure \ref{overview}.
