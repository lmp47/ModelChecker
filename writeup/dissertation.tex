...
may have side effects; Haskell programs use instances of the
...
used by the backend. In particular, \verb,toModel, takes a \verb,Parser.AigModel.Model,
...
\end{lstlisting}
\caption{Function that approximates the {\it mic} algorithm.}
...
than any proof obligation $(v,i)$ (with the same depth) already in the queue.
